  ...
  return (
    <section className="section-style x-spacing min-h-[70vh] flex flex-col items-center justify-center">
      <SVG
        ...
        className="absolute w-[250px] sm:w-[300px] left-[-100px] sm:left-[-400px] bottom-40 sm:bottom-50 md:top-[300px] block overflow-hidden rotate-180 -z-10"
      ...
      <SVG
        src="/assets/images/home/svgs/halfCircleRight.svg"
        className="absolute w-[250px] sm:w-[300px] right-[-100px] sm:right-[-100px] bottom-40 sm:bottom-50 md:top-[300px] block overflow-hidden -z-10"
        alt="Background decoration"
        width={500}
        height={265}
        preserveAspectRatio="xMidYMid slice"

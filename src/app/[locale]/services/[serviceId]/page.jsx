...
export default async function Service({ params }) {
  ...
  if (!service) {
    return (
      <main className="section-style x-spacing py-20">
        <div className="text-center">
          <h1 className="main-heading text-secondaryColor mb-4">Service Not Found</h1>
          <p className="text-lg mb-8">The requested service could not be found.</p>
          <a href="/services" className="primary-button inline-block py-3 px-6">
            Back to Services
          </a>
        </div>
      </main>

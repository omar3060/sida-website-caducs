...
export default function OTPPage() {
  ...
  return (
    <section className="section-style x-spacing mb-15 min-h-screen items-center justify-center relative">
      ...
      <SVG
        ...
        className="absolute w-[50px] sm:w-[300px] left-[-100px] sm:left-[-400px] bottom-40 sm:bottom-50 md:top-[300px] block overflow-hidden rotate-180 "
      ...
      <SVG
        src="/assets/images/home/svgs/halfCircleRight.svg"
        className="absolute w-[250px] sm:w-[300px]  sm:right-[-100px] bottom-40 sm:bottom-50 md:top-[300px] block overflow-hidden"
        alt="Hero illustration"
        width={500}
        height={265}
        preserveAspectRatio="xMidYMid slice"

...
const HeroHelp = () => {
  return (
    <section className="section-style x-spacing w-full h-[400px] mt-20  bg-mainColor text-textWhite text-center justify-center items-center flex-col gap-15 py-[50px]">
      ...
      <form class="mx-auto flex items-center justify-center">
        <div class="relative">
          
          <input
            type="search"
            id="default-search"
            class="bg-textWhite text-secondaryColor rounded-2xl outline-0 w-[350px] md:w-[400px] h-[35px] pl-3"
            placeholder="Search..."
            required
          />
          <button
            type="submit"
            class="flex justify-end absolute end-0 -top-2.5 m-2.5 h-full w-8 text-mainColor"
          >
